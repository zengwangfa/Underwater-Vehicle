...
//------------------------------------------------------------------------------------------//
		...
		ef_port_write(Nor_FLASH_ADDRESS+4*PropellerParamter_MED_A,(uint32 *)&PropellerParameter.PowerMed,4);		// 地址
		ef_port_write(Nor_FLASH_ADDRESS+4*PropellerParamter_MAX_A,(uint32 *)&PropellerParameter.PowerMax,4); // 地址
		ef_port_write(Nor_FLASH_ADDRESS+4*PropellerParamter_MIN_A,(uint32 *)&PropellerParameter.PowerMin,4); // 地址
